 ...
 */
class Wp_Companion_Mortgage_Toolkit {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wp_Companion_Mortgage_Toolkit_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'wp-companion-mortgage-toolkit';
	 ...
	 *
	 * - Wp_Companion_Mortgage_Toolkit_Loader. Orchestrates the hooks of the plugin.
	 * - Wp_Companion_Mortgage_Toolkit_i18n. Defines internationalization functionality.
	 * - Wp_Companion_Mortgage_Toolkit_Admin. Defines all hooks for the admin area.
	 * - Wp_Companion_Mortgage_Toolkit_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Wp_Companion_Mortgage_Toolkit_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wp_Companion_Mortgage_Toolkit_Loader    Orchestrates the hooks of the plugin.
	 */
